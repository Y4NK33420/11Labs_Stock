...
class TwilioAudioInterface(AudioInterface):
    ...
    def output(self, audio: bytes):
        """
        Sends the generated audio back to Twilio.
    ...
    async def handle_twilio_message(self, data):
        """
        Processes messages from Twilio.
        - For "start" events, it initializes the stream_sid.
        - For "media" events, it decodes the audio and passes it to the input callback.
        """
